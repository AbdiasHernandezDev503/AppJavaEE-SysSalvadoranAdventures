...
<html>
    ...
    <body>
        ...
        <main class="container">   
            <h5>Crear Municipio</h5>
            <form action="Municipality" method="post">
                <input type="hidden" name="accion" value="<%=request.getAttribute("accion")%>">                
                <div class="row">
                    <div class="input-field col l4 s12">
                        <input  id="txtNombre" type="text" name="municipalityName" required class="validate" maxlength="60">
                     ...
                     <div class="input-field col l4 s12">   
                        ...
                        <span id="slDepar
                        tment_error" style="color:red" class="helper-text"></span>
                    </div>
                </div>
                <div class="row">
