...
<html>
    ...
    <body>
        ...
        <main class="container">   
            <h5>Crear Usuario</h5>
            <form action="User" method="post" onsubmit="return  validarFormulario()" enctype="multipart/form-data">
                <input type="hidden" name="accion" value="<%=request.getAttribute("accion")%>">                
                <div class="row">
                    <div class="input-field col l4 s12">
                        <input  id="txtNombre" type="text" name="name" required class="validate" maxlength="50">
                        <label for="txtNombre">Nombre</label>
                    </div>                       
                    <div class="input-field col l4 s12">
                        <input  id="txtApellido" type="text" name="lastName" required class="validate" maxlength="50">
                        <label for="txtApellido">Apellido</label>
                    </div> 
                    <div class="input-field col l4 s12">
                        <input  id="txtTelephone" type="text" name="telephone" required class="validate" maxlength="10">
                        <label for="txtTelephone">Telefono</label>
                    </div> 
                    <div class="input-field col l4 s12">
                        <input  id="txtLogin" type="text" name="login" required class="validate" maxlength="60">
