        ...
        <main class="container">   
            ...
            <div class="row">
                <div class="input-field col l4 s12">
                    <input disabled  id="txtNombre" name="name" type="text" value="<%=rol.getName()%>">
                    <label for="txtNombre">Nombre</label>
                </div>                                         
            </div>
            <div class="row">
                <div class="col l12 s12">
                    <a href="Rol?accion=edit&id=<%=rol.getIdRol()%>" class="waves-effect waves-light btn blue"><i class="material-icons right">edit</i>Ir modificar</a>                        
