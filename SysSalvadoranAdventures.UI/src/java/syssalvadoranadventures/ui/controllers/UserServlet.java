...
public class UserServlet extends HttpServlet {
    ...
    private String pathFiles = "C:\\Users\\abdia\\OneDrive\\Documentos\\PROYECTOSDEJAVAEE\\SysSalvadoranAdventuresW\\SysSalvadoranAdventures.UI\\web\\wwwroot\\usersProfilePhotos";
    ...
    private String guardarImagen(Part part, File pathUpload) {
        ...
        return "wwwroot\\usersProfilePhotos\\" + fileName;
    }
    ...
    private User getUser(HttpServletRequest request) {
        ...
        usuario.setPhoto(Utilidad.getParameter(request, "photo", ""));
